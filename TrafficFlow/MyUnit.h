...
__published:	// IDE-managed Components
	...
	void __fastcall DelRowMenuClick(TObject *Sender);
	void __fastcall AddRowMenuClick(TObject *Sender);
	void __fastcall InsertRowMenuClick(TObject *Sender);
	void __fastcall InitialTableDblClick(TObject *Sender);
private:	// User declarations
	String FileName;
	bool __fastcall saveData(bool showDialog);
	bool __fastcall CheckChangesAndSave();
	void __fastcall InitialData(const String& 	);
	void __fastcall ValidateInputData();
	int __fastcall CalGridColWidth(TStringGrid* Grid,int Col);
	void SortGridByColumn(TStringGrid *grid, int col, bool ascending);
	void UpdateColumnHeader(TStringGrid *grid, int col, bool ascending);
public:
